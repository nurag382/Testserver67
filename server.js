...
const app = express();
// Priority: Hosted Port > .env Port > 3000
const PORT = process.env.PORT || 3000;

// --- CONFIGURATION ---
const API_KEY = process.env.BYTEZ_API_KEY; 
const IMAGE_LIMIT = parseInt(process.env.IMAGE_LIMIT) || 20;
...
app.get('/', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            #loader-screen { position: fixed; inset: 0; background: #000; z-index: 9999; display: flex; flex-direction: column; items: center; justify-content: center; transition: 0.8s ease; }
            .infinity-path { width: 80px; height: 40px; border: 4px solid #a855f7; border-radius: 50px 50px 0 50px; transform: rotate(-45deg); animation: pulse 1.5s infinite; position: relative; }
...
app.listen(PORT, () => { console.log("🚀 Platinum V10 Live on Port " + PORT); });
